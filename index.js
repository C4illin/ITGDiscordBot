...
bot.on("message", (message) => {
  ...
  case "seaside":
    ...
    request(url, function(err, resp, body) {
      ...
      let menytextlower = menytext.toLowerCase()
      message.channel.send({
        embed: new Discord.RichEmbed()
          .addField("Måndag", menytext.substring(6, menytextlower.indexOf("tisdag")))
          .addField("Tisdag", menytext.substring(menytextlower.indexOf("tisdag")+6, menytextlower.indexOf("onsdag")))
          .addField("Onsdag", menytext.substring(menytextlower.indexOf("onsdag")+6, menytextlower.indexOf("torsdag")))
          .addField("Torsdag", menytext.substring(menytextlower.indexOf("torsdag")+7, menytextlower.indexOf("fredag")))
          .addField("Fredag", menytext.substring(menytextlower.indexOf("fredag")+6, menytextlower.indexOf("här på seaside")))
          .setColor(0xffcc77),
      })
    })
